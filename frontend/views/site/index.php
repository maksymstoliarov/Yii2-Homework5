...
<div class="site-index">
    ...
    <div class="jumbotron">
        <h1 align="center"><?= Yii::t('app', 'Congratulations!'); ?></h1>

        <p class="lead" align="center"><?= Yii::t('app', 'You have successfully created your Yii-powered application.'); ?></p>

        <p align="center"><a class="btn btn-lg btn-success" href="http://www.yiiframework.com"><?= Yii::t('app', 'Get started with Yii');  ?></a></p>
    </div>
